...
{
    private CommentedPost commente1;
    ...
    public void setUp()
    {
        messageP1 = new MessagePost("Author1", "This is a message");
        photoPos1 = new PhotoPost("Author2", "C:\\files\\picture.jpg", "This is a nice picture");
        newsFeed1 = new NewsFeed();
        newsFeed1.addPost(messageP1);
        newsFeed1.addPost(photoPos1);
        eventPos1 = new EventPost("Author1");
    }
