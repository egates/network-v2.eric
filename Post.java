...
public class Post 
{
    ...
    /**
     * Return the string from timeString
     * 
     * @returns A string indicating how much time has passed since the post was created
     */
    ...
    /** Return the username private field
     * 
     * @return username Name of User who made the post
     */
